...
/plugin list       # expect bsa-full@1.2.2 (v1.2.x line; manifest may lag git tag during canon-neutral patch releases)
```
...
**v1.2.2** — current release. The v1.2.x line opens with v1.2.0 (one-line cross-ref edit, first canon bump since v1.1.6), v1.2.1 (A51 `link_strength_override` enum, closes TODO-S8-02-LINK-STRENGTH-OVERRIDE), and v1.2.2 (A72 incremental-diff helper, closes TODO-S8-02-INCREMENTAL-MATRIX). v1.1.x background:
