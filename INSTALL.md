...
Expected output includes `bsa-full@1.2.1` (the manifest version of the current v1.2.x line; tag may be ahead during canon-neutral patch releases — the same two-semver discipline that kept manifest at 1.1.6 across v1.1.7..v1.1.19).
